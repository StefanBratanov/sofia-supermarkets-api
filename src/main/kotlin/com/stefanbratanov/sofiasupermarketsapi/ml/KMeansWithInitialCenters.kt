 ...
 * copied from
 *
 * @see org.apache.commons.math3.ml.clustering.KMeansPlusPlusClusterer only difference is that we
 *   can define our own initial centers
 */
class KMeansWithInitialCenters(
  ...
  override fun cluster(
    points: MutableCollection<TextWithCoordinates>?
  ): List<CentroidCluster<TextWithCoordinates>> {
    // sanity checks
    // sanity checks
  ...
  private fun getPointFromLargestVarianceCluster(
