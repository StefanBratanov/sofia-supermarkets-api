...
internal class GoogleImageSearchTest {
  ...
  @MockkBean private lateinit var productImageRepository: ProductImageRepository

  @Autowired private lateinit var underTest: GoogleImageSearch
  ...
  fun `calls google search api`() {
    ...
    verify(exactly = 1) { productImageRepository.save(expectedImage) }
  }
}
